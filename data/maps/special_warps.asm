...
.CeruleanCity:   fly_warp CERULEAN_CITY,   19, 20
.LavenderTown:   fly_warp LAVENDER_TOWN,    3,  8
.VermilionCity:  fly_warp VERMILION_CITY,  11,  6
.CeladonCity:    fly_warp CELADON_CITY,    41, 12
.FuchsiaCity:    fly_warp FUCHSIA_CITY,    19, 30
.CinnabarIsland: fly_warp CINNABAR_ISLAND, 11, 14
.IndigoPlateau:  fly_warp INDIGO_PLATEAU,   9,  8
.SaffronCity:    fly_warp SAFFRON_CITY,     9, 32
.Route4:         fly_warp ROUTE_4,         11,  8
